...
t_INT = r"(" + binary_literal + r"|" + octal_literal + \
    r"|" + hex_literal + r"|" + decimal_literal + r")"

decimal_exponent = r"([eE][\+-]?" + decimal_digits + r")"
decimal_float_literal = r"(((" + decimal_digits + r")\.(" + decimal_digits + r")?(" + decimal_exponent + r")?)|(" + \
    decimal_digits + decimal_exponent + \
    r")|(\." + decimal_digits + r"(" + decimal_exponent + r")?))"

hex_exponent = r"([pP][\+-]?" + decimal_digits + r")"
hex_mantissa = r"(((\_?" + hex_digits + r"\." + hex_digits + \
    r"?)|(\_?" + hex_digits + r")|(\." + hex_digits + r")))"
...
big_u_val = r"(\\U" + hex_digit + hex_digit + hex_digit + \
    hex_digit + hex_digit + hex_digit + hex_digit + hex_digit + r")"
...
unicode_char = r"([^\n\'\\])"
unicode_val = r"(" + unicode_char + r"|" + little_u_val + \
    r"|" + big_u_val + r"|" + escp_char + r")"
